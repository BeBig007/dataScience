...
sql_content += '\tcategory_code VARCHAR(100),\n'
sql_content += '\tbrand VARCHAR(50)\n'
sql_content += ');\n\n'
...
sql_content += 'ADD COLUMN category_code VARCHAR(100),\n'
sql_content += 'ADD COLUMN brand VARCHAR(50);\n\n'


sql_content += 'UPDATE customers\n'
sql_content += 'SET category_id = item.category_id,\n'
sql_content += '\tcategory_code = item.category_code,\n'
sql_content += '\tbrand = item.brand\n'
